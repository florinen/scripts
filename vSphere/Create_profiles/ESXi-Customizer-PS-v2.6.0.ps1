...
if ($help) {
    write-host "`nUsage:"
    write-host "   ESXi-Customizer-PS [-help] | [-izip <bundle> [-update]] [-sip] [-v70|-v67|-v65|-v55|-v51|-v50]"
    ...
    write-host "   -v70 | -v67 | -v65 |"
    write-host "   -v55 | -v51 | -v50 : Use only ESXi 7.0/6.7/6.5/5.5/5.1/5.0 Imageprofiles as input, ignore other versions"
...
if ( ($v50 -and ($v51 -or $v55 -or $v65 -or $v67 -or $v70)) -or ($v51 -and ($v55 -or $v65 -or $v67 -or $v70)) -or ($v55 -and ($v65 -or $v67 -or $v70)) -or ($v65 -and ($v67 -or $v70)) -or ($v67 -and $v70) ) {
